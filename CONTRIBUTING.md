...
issue](https://github.com/cisagov/performance-goals/issues) in this
...
request](https://github.com/cisagov/performance-goals/pulls), you will
...
```console
cd performance-goals
pyenv virtualenv <python_version_to_use> performance-goals
pyenv local performance-goals
